...
Installation
------------
Extract the module archive, copy its contents to your modules directory 
and activate the module.

Usage - Automatic
-----------------
Webform conditional email enhance the email configuration for webform. 
Admin can send email to different users based on the conditions. 
Admin can set different conditions based on the component and input values 
provided by end-users.


Usage - Manual
--------------
With the following set of operators user can create conditions 
to send email on webform submissions
